...
@Config
@Autonomous(name = "Gate Spam Red 9 Close")
public class Red9GateCycle extends NextFTCOpMode {
    public Red9GateCycle() {
        addComponents(
...
//                .setTangentHeadingInterpolation().setReversed()
        ...
        gateHold = PedroComponent.follower().pathBuilder().addPath(
                        new BezierLine(
                                scorePose,
                                new Pose(126.7, 70)
...
//                                        HeadingInterpolator.tangent
        ...
        gateOpen = PedroComponent.follower().pathBuilder().addPath(
                        new BezierLine(
                                new Pose(126.7, 70),
                                new Pose(100, 70)
                        )
...
//                    s.i.shoot(1),
                new SequentialGroup(
                        new FollowPath(gateHold),
                        new Delay(5),
                        new FollowPath(gateOpen)
                )
//                    new Delay(1),
/*
                new ParallelGroup(
